...
describe('RECEIVE_GENRES', () => {
  test('returns the correct state', () => {
    ...
    const expectedState = JSON.parse('{"genreNames": {"12": "Adventure", "16": "Animation", "28": "Action", "35": "Comedy"}, "genresLoading": false, "loading": false, "ratingMinimum":0}');
